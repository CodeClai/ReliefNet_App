...
class BeneficiaryMapScreen extends StatefulWidget {
  const BeneficiaryMapScreen({super.key});
  @override
  State<BeneficiaryMapScreen> createState() => _BeneficiaryMapScreenState();
}

class _BeneficiaryMapScreenState extends State<BeneficiaryMapScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Aid Campaigns Near You')),
      body: loading
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (c['address']!= null) Text('Location: ${c['address']}'),
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: const Text('Request Aid from This Campaign'),
              ),
            ),
          ],
        ),
